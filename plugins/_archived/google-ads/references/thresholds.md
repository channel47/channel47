# Detection Thresholds & Dollar Formulas
...
|------------|---------------|---------|
| 1. Non-converting keywords | Pause keyword or reduce bid | See ui-paths.md > Keywords > Pause a keyword |
| 2. Low QS keywords | Improve ad relevance + landing page; pause if QS <= 3 | See ui-paths.md > Keywords > Pause a keyword |
| 3. Display on Search | Disable content network targeting | See ui-paths.md > Campaigns > Disable Display network |
| 4. Budget-limited | Increase budget or reduce waste elsewhere to fund | See ui-paths.md > Campaigns > Adjust campaign budget |
| 5. Broad without negatives | Add shared negative list | See ui-paths.md > Negative Keywords > Create or add to shared list |
| 6. Single-ad groups | Create additional RSA variants | See ui-paths.md > Ad Copy > Edit RSA headlines/descriptions |
| 7. Zero-impression campaigns | Investigate setup; pause if abandoned | See ui-paths.md > Campaigns > Pause a campaign |
| 8. Non-converting search terms | Add as negative keywords | See ui-paths.md > Negative Keywords > Add campaign-level negatives |
