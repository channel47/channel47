...
- For detailed XML tag documentation: `assets/reference/xml-tag-library.md`
- For quick cheatsheet: `assets/reference/quick-reference.md`
- For task-type templates: `assets/examples/task-type-templates.md`
- For common pitfalls: `assets/reference/common-pitfalls.md`
...
For common mistakes and red flags to avoid, see: `assets/reference/common-pitfalls.md`
