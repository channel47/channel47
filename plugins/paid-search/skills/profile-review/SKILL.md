...
description: >-
  ...
  Audits the account profile for stale watch list entries, lingering tests,
  bloated decision logs, and outdated targets.
version: 0.1.0
---

# Profile Review — Paid Search
...
- Ask whether KPI targets (CPA, ROAS, budget, impression share) are
  still current.
