...
This skill uses:
- [Performance Benchmarks](./references/performance-benchmarks.md) - Industry averages by vertical for comparison
...
1. **Google Ads MCP configured** - Ensure the Google Ads MCP server is connected
...
> "Google Ads MCP is required for auditing. Ensure the MCP server is configured, then try again."
...
Reference: [Performance Benchmarks](./references/performance-benchmarks.md)
